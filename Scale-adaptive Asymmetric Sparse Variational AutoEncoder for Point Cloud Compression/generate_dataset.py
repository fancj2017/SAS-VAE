...
if __name__ == "__main__":
    mesh_rootdir = "/home/hw/Desktop/fsan/training_dataset"
    pc_rootdir = './dataset/'
    #out_filetype = 'ply'
    out_filetype = 'h5'
    num_mesh = 100
    ...
    mesh_filedirs = [f for f in input_filedirs if (os.path.splitext(f)[1]=='.ply' or os.path.splitext(f)[1]=='.h5')]# .off or .obj
