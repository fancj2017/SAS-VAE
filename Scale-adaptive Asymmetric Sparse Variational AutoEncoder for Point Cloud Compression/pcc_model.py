...
#from autoencoder_base import Encoder, Decoder
...
class PCCModel(torch.nn.Module):
    def __init__(self):
        super().__init__()
        self.encoder = Encoder(channels=[1,32,64,128,64,16])#[1,16,32,64,32,8]
        self.decoder = Decoder(channels=[16,128,64,32])#[8,64,32,16]
        self.entropy_bottleneck = EntropyBottleneck(16)#8
